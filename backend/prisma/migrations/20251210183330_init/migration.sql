...
-- CreateTable
CREATE TABLE "_PostSavedLists" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_PostSavedLists_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_PostSavedLists_B_index" ON "_PostSavedLists"("B");
...
-- AddForeignKey
ALTER TABLE "_PostSavedLists" ADD CONSTRAINT "_PostSavedLists_A_fkey" FOREIGN KEY ("A") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PostSavedLists" ADD CONSTRAINT "_PostSavedLists_B_fkey" FOREIGN KEY ("B") REFERENCES "SavedList"("id") ON DELETE CASCADE ON UPDATE CASCADE;
